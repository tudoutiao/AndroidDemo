...
public class CaptchaActivity extends AppCompatActivity {
    String noSenseCaptchaId = "822c9d1a15d4467294e02bdd64420636";
    String traditionalCaptchaId = "822c9d1a15d4467294e02bdd64420636";
    ...
    private void initView() {
        ...
        switchControlBar.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
    ...
    private void initClickListener(final Context context) {
        // 传统验证码
        btnTraditionalCaptcha.setOnClickListener(view -> {
        ...
        // 智能无感知验证码
        btnNoSenseCaptcha.setOnClickListener(view -> {
            if (isUsedCustomControlBarStyle) {
                controlBarStartUrl = etControlBarSlide.getText().toString();
                controlBarMovingUrl = etControlBarSlideMove.getText().toString();
                controlBarErrorUrl = etControlBarSlideError.getText().toString();
    ...
    private void initData() {
        captchaListener = new CaptchaListener() {
            ...
            public void onError(int i, String s) {
                Toast.makeText(getApplicationContext(), "验证出错" + s, Toast.LENGTH_LONG).show();
            }
