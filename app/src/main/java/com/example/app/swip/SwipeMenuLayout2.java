...
public class SwipeMenuLayout2 extends ViewGroup {
    private static final String TAG = "SwipeMenuLayout2";
    ...
    private static SwipeMenuLayout2 mCacheView;
    ...
    public void expandMenuAnim() {
        ...
        cleanAnim();
        //展开就赋值
        mCacheView = SwipeMenuLayout2.this;
        //禁止长按事件
    ...
    public SwipeMenuLayout2 getCacheView() {
        return mCacheView;
    }
    ...
    //设置是否打开阻塞
    public SwipeMenuLayout2 setOpenChoke(boolean openChoke) {
    ...
    //设置是否开启侧滑菜单
    public SwipeMenuLayout2 setEnableSwipe(boolean enableSwipe) {
    ...
    //设置菜单是否在左侧
    public SwipeMenuLayout2 setEnableLeftMenu(boolean enableLeftMenu) {
    ...
    //设置 点击菜单后是否直接关闭菜单
    public SwipeMenuLayout2 setClickMenuAndClose(boolean clickMenuAndClose) {
        isClickMenuAndClose = clickMenuAndClose;
        return this;
    }

    public SwipeMenuLayout2 setSwipeMenuStateListener(SwipeMenuStateListener listener) {
