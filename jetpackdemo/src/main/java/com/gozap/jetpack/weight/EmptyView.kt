package com.gozap.jetpack.weight
...
class EmptyView(context: Context, attrs: AttributeSet?) : LinearLayout(context, attrs),
    ...
    init {
        ...
        mDrawableIds[0] = a.getInt(R.styleable.EmptyView_comEmptyDrawable, R.mipmap.empty_bg)
        mDrawableIds[1] = a.getInt(R.styleable.EmptyView_comErrorDrawable, R.mipmap.empty_bg)
